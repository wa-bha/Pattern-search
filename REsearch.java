...
public class REsearch {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            System.err.println("#1: REGEX: 'a(bra)+cada(bra)+'      : cat abracadabraFSM.txt | java REsearch abraTestInput.txt > out.txt");
        ...
        //DEBUG FILEREADER
        //try (BufferedReader fileReader = new BufferedReader(new FileReader("abraTestInput.txt"))){
            ...
            for (int pointer = marker; deque.checkHead(); pointer++) {
                ...
                for (int currentStateValue = deque.getHead(); currentStateValue != SCAN_STATE; currentStateValue = deque.getHead()) {
                    ...
                    if (currentNode.ch.equals("br")) {
                        ...
                        if (fsmNodes.get(currentNode.next1).ch.equals("null") || fsmNodes.get(currentNode.next2).ch.equals("null")) {
                            return true;
                        }
                    }
